...
export default function TrueFalsePage() {
  ...
  const getButtonStyle = (buttonType: boolean) => {
    if (!isAnswered)
      return "border-gray-200 text-gray-700 hover:border-slate-300 hover:bg-slate-50";
                ...
                <RichContent
                    ...
                    <div className="space-y-6 mt-12">
                      <div className="flex justify-between items-start gap-6">
                        <div>
                          ...
                          <p className="mt-4 text-sm italic text-slate-500 flex-1">
                            eg: {currentQuiz.example || "No example provided"}
                          </p>
                        </div>
                  ...
                  body={
                    <div className="flex-1 flex flex-col justify-center my-10">
                      ...
                      {isAnswered && feedback && (
                        <p
                          className={`mt-4 text-sm font-bold animate-in fade-in duration-300 ${
                    ...
                    <div className="mt-auto">
                      ...
                      <div className="grid grid-cols-2 gap-6 mb-6">
                        <button
                          ...
                          className={`flex items-center justify-center gap-3 py-4 rounded-2xl border-2 transition-all text-lg font-bold ${getButtonStyle(
                            true
                          )}`}
                        >
                          {isAnswered && isStatementCorrect && (
                            <Check size={24} />
                          )}
                          {isAnswered &&
                            !isStatementCorrect &&
                            userSelected === true && <X size={24} />}
                          True
                        </button>
